...
public class AppUtils {
    ...
    public static boolean isInstalled(Context context, String packageName) {
        LogUtils.e("dswang", "AppUtils.packageName = " + packageName);
        ...
        for (ApplicationInfo in : installedApplications) {
            LogUtils.e("dswang", "AppUtils.isInstalled.packageName = " + in.packageName);
            if (packageName.equals(in.packageName)) {
                installed = true;
                LogUtils.e("dswang", "AppUtils.hasInstalled = " + in.packageName);
                break;
            } else {
                installed = false;
            }
